...
import com.mastering.spring.springboot.Chapter07.Chapter07Application;
import com.mastering.spring.springboot.Chapter07.bean.Todo;

@RunWith(SpringJUnit4ClassRunner.class)
@SpringBootTest(classes = Chapter07Application.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class TodoControllerIT {
	...
	public void addTodo() throws Exception {
		Todo todo = new Todo(4, "Jill", "Learn Hibernate", new Date(), false);
